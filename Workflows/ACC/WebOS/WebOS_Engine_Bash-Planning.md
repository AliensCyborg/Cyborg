---
# [ACC.WORKFLOW] WebOS Engine Bash - Planning
WorkflowId: WebOS_Engine_Bash-Planning
WorkflowName: WebOS Engine Bash Planning
...
- No code writes in WebOS engine locations
- No docs writes
...
## B) Entry + Invocation
- How it is called (from which workflow / which WebOS automation)
...
## I) Files to Write
- Code output path: `/Aliens/WebOS/{LatestVersion}/Unit/bash/{EngineName}.sh`
- Docs output path: `/Aliens/Docs/WebOS/Engines/Bash/{EngineName}.md`
- Plan output path: `/Aliens/.Alien/{Developer_Username}/Planning/WebOS/Engine/Bash/{EngineName}.plan.md`
