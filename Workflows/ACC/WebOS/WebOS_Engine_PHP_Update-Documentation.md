---
WorkflowId: WebOS_Engine_PHP_Update-Documentation
WorkflowName: WebOS Engine PHP Update (Documentation)
...
Outputs:
  - Docs: "/Aliens/Docs/WebOS/Engine/PHP/{EngineBaseName}.md"
...
- Else: create new under `/Aliens/Docs/WebOS/Engine/PHP/{EngineBaseName}.md`.
...
Additionally (PHP Engine Update specific), ensure sections include:
