---
WorkflowId: WebOS_Engine_PHP_Update-Audit
WorkflowName: WebOS Engine PHP Update (Audit)
...
ExampleFiles:
  ...
  - "/Aliens/WebOS/PHP.26.00.00/Engine/WebOS.Router.php"
  - "/Aliens/WebOS/PHP.26.00.00/Engine/WebOS.AppRegistry.php"
  - "/Aliens/WebOS/PHP.26.00.00/Engine/WebOS.WebAPI.php"
...
...
## [00] Purpose
Is workflow ka kaam: **enterprise-grade audit** of an existing WebOS PHP engine file before update.
...
- First line copyright marker (mandatory for WebOS engines)
...
5) `$echo` and `d()/x()` usage not per WebOS convention OR not guarded
...
- File naming: `WebOS.{Short}.php`
- Class naming: `WebOS_{Short}`
...
- Best-effort discovery:
  - Search for call patterns: `WebOS::{EngineShortName}{Action}(` across repo (read-only)
...
### E) Docs Drift
- Existing docs file present? `/Aliens/Docs/WebOS/Engine/PHP/{EngineBaseName}.md`
