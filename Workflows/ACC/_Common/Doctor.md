...
Outputs:
  Planning:
    Location: "/Aliens/.Alien/{Developer_Username}/Planning/Doctor/{RunId}/Doctor.Plan.md"
  Code:
    SaveStrategy: "modify-only (mechanical safe patches only)"
  Documentation:
    Location: "/Aliens/Docs/Doctor/{RunId}.md"
...
## [07] Example
`Workflow("Doctor", "Auto", "<paste logs>")`
