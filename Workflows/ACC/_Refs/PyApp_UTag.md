...
Purpose: >
  ...
  across the entire PyOS ecosystem (thousands of PyApps, many machines).
NonNegotiables:
  - UTagIsHtmlTag: true
...
# PyApp — UTag (Global Uniqueness SSOT)
...
- Not just within an app — across **all** PyApps in PyOS ecosystem
...
- When code eventually merges to a central repo, a CI audit can scan all PyApps for duplicate UTags.
