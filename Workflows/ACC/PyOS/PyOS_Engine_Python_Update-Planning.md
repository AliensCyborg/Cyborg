---
WorkflowId: PyOS_Engine_Python_Update-Planning
WorkflowName: PyOS Engine Python Update Planning
...
## [00] Purpose
Is workflow ka kaam: **sirf update planning generate** karna for an existing PyOS Python Engine.

Output:
- `/Aliens/.Alien/{Developer}/Planning/PyOS/Engine/py/{EngineBaseName}.update.plan.md`
...
## [01] Inputs
- Targets: single engine (normalized like PyOS_Engine_Python-Planning)
...
12) Validation Checklist (python -m py_compile, router contract, style gates)
