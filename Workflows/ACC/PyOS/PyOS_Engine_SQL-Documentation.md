---
WorkflowId: PyOS_Engine_SQL-Documentation
WorkflowName: PyOS Engine SQL - Documentation
...
Outputs:
  - DocFile: "/Aliens/Docs/PyOS/Engine/SQL/{EngineBaseName}.md"
Requires:
...
- Target paths (SQL file path + where it lives in PyOS)
