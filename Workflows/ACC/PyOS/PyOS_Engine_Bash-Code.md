---
# [ACC.WORKFLOW] PyOS Engine Bash - Code
WorkflowId: PyOS_Engine_Bash-Code
WorkflowName: PyOS Engine Bash Code
...
PyOS ecosystem standards ke hisaab se.
...
- Similar Bash engines in `/Aliens/PyOS/{LatestVersion}/Unit/bash/`
...
- Forbidden cross-language tokens:
  - `$echo` must not appear anywhere (Python leakage)
...
Write run log:
- `/Aliens/.Alien/{Developer_Username}/Task/Logs/ACC/PyOS_Engine_Bash-Code/{RunId}.log.md`
