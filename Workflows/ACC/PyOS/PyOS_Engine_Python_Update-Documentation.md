---
WorkflowId: PyOS_Engine_Python_Update-Documentation
WorkflowName: PyOS Engine Python Update (Documentation)
...
Outputs:
  - Docs: "/Aliens/Docs/PyOS/Engine/py/{EngineBaseName}.md"
...
## [00] Purpose
Update workflow ke baad engine docs ko **enterprise-grade** align karna.
...
Docs goals:
- Return-Type Matrix (public actions)
- Coverage Inventory (who calls it / routes)
...
- Else: create new under `/Aliens/Docs/PyOS/Engine/py/{EngineBaseName}.md`.
...
Additionally (Python Engine Update specific), ensure sections include:
- Engine Contract (Router actions + required params)
- Return-Type Matrix
- Coverage Inventory
- Backward compatibility notes
...
- Return-Type Matrix and examples are complete.
