---
WorkflowId: WebSDK_Module_API_Update-Planning
WorkflowName: WebSDK Module API Update Planning
...
Outputs:
  - PlanningDoc: "/Aliens/.Alien/{Developer_Username}/Planning/WebSDK/Module/{Module}/API/{ApiName}.update.plan.md"
  - AuditDoc: "/Aliens/.Alien/{Developer_Username}/Planning/WebSDK/Module/{Module}/API/{ApiName}.update.audit.md"
...
# WebSDK_Module_API_Update-Planning.md
...
**Role (Hinglish):**  
Yeh file `WebSDK_Module_API_Update` ke liye **UPDATE Planning generator** hai.  
...
> Important: Is file me sirf WebSDK API UPDATE planning ke unique rules honge.  
...
Targets:
- `Module/ApiName` => WebSDK module + API name (without extension)
...
- In this mode workflow MUST:
  - Enumerate existing API files:
    - `{ModuleRoot}/api/*.php` (non-recursive)
  - Derive `ApiName` from filename (without `.php`)
...
- `{PlanDoc} = /Aliens/.Alien/{Developer_Username}/Planning/WebSDK/Module/{Module}/API/{ApiName}.update.plan.md`
...
0) Deterministic audit artifact exists
   - `/Aliens/.Alien/{Developer_Username}/Planning/WebSDK/Module/{Module}/API/{ApiName}.update.audit.md`
   - If missing:
     - `Failed(AuditMissing)`
...
- Any business logic must live in existing module class (`php/index.php`)
...
File:
- `/Aliens/.Alien/{Developer_Username}/Planning/WebSDK/Module/{Module}/API/{ApiName}.update.plan.md`
