---
WorkflowId: WebSDK_Module_SQL_Update
...
Summary: >
  Plural UPDATE-only workflow that updates one or multiple existing WebSDK module SQL bundles.
...
Calls:
  - "Workflows/ACC/WebSDK/WebSDK_Module_SQL_Update-Audit.md"
  - "Workflows/ACC/WebSDK/WebSDK_Module_SQL_Update-Planning.md"
  - "Workflows/ACC/WebSDK/WebSDK_Module_SQL_Update-Code.md"
  - "Workflows/ACC/WebSDK/WebSDK_Module_SQL_Update-Reaudit.md"
  - "Workflows/ACC/WebSDK/WebSDK_Module_SQL_Update-Documentation.md"
Inputs:
  - Name: Targets
    Type: string
    Required: true
...
## Purpose
`WebSDK_Module_SQL_Update` ek **Plural UPDATE-only** workflow hai jo **existing** module SQL bundle ko update karwata hai.

Example:
- `Workflow("WebSDK_Module_SQL_Update", "Teacher", "Existing sql/index.sql me new column add karo")`
- `Workflow("WebSDK_Module_SQL_Update", "Teacher,User", "In dono modules ke index.sql ko harden karo")`
...
3) If `{SqlFile}` exists:
   - MUST call child workflows in order:
     1) `WebSDK_Module_SQL_Update-Audit` (read-only)
     2) `WebSDK_Module_SQL_Update-Planning` (update plan)
     3) `WebSDK_Module_SQL_Update-Code` (modify-only update)
     4) `WebSDK_Module_SQL_Update-Documentation` (final docs + update notes)
...
Calls:
1) `Workflow("WebSDK_Module_SQL_Update-Audit", "<Module>", "<Description>")`
2) `Workflow("WebSDK_Module_SQL_Update-Planning", "<Module>", "<Description>")`
3) `Workflow("WebSDK_Module_SQL_Update-Code", "<Module>", "<Description>")`
4) `Workflow("WebSDK_Module_SQL_Update-Documentation", "<Module>", "<Description>")`
...
- Docs updated under `/Aliens/Docs/WebSDK/Module/{Module}/SQL/index.md`
