---
WorkflowId: WebSDK_Module_Screen-Documentation
WorkflowName: WebSDK Module Screen Documentation Generator
...
Produces:
  - Documentation: "/Aliens/Docs/WebSDK/Module/{Module}/Screen/{ScreenNameOrIndex}.md"
...
# WebSDK_Module_Screen-Documentation.md
...
## Role
Screen docs generate karo.

Must include:
- Purpose
- Route/entry assumptions
- Inputs and outputs
- Dependencies

Save:
- `/Aliens/Docs/WebSDK/Module/{Module}/Screen/{ScreenNameOrIndex}.md`
