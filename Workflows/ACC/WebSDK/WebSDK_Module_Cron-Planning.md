---
WorkflowId: WebSDK_Module_Cron-Planning
WorkflowName: WebSDK Module Cron Planning
...
ExampleFiles:
  - "/Aliens/WebSDK/PHP.26.00.00/Module/Product/cron/index.php"
  - "/Aliens/WebSDK/PHP.26.00.00/Module/Product/cron/Product_OrdersPayment.php"
---

# WebSDK_Module_Cron-Planning.md
...
- If `Targets` has no `/` => module-only baseline:
  ...
  - Plan creates/updates `cron/index.php` placeholder (optional) and records folder baseline.
...
- `{CronIndex} = {CronFolder}/index.php`
- `{CronFile} = {CronFolder}/{CronName}.php` (item mode)
...
## Save
- `/Aliens/.Alien/{Developer_Username}/Planning/WebSDK/Module/{Module}/Cron/{CronNameOrIndex}.plan.md`
