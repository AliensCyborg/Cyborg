---
WorkflowId: PyApp_Update-Audit
WorkflowName: PyApp Update Audit
...
Outputs:
  Artifacts:
    ...
    FileName: "PyApp_Update-Audit.md"
Safety:
  NoDelete: true
  ProdWrite: "no"
...
ExampleFiles:
  ...
  - "/Aliens/PySDK/Py.26.00.00/Module/Product/js/index.py" (legacy/placeholder)
...

# [0] Purpose
`Workflow("PyApp_Update-Audit", "{AppName}", "{Description}")`
...
Optional:
- `/Aliens/.Alien/{Developer}/Audit/PyApp/{AppName}/PyApp_Update-Findings.csv`
