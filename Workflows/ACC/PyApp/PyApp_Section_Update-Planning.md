---
WorkflowId: PyApp_Section_Update-Planning
Type: Workflow_Singular-Planning
Domain: PyApp
Scope: Generate update planning for a PyApp Section (per target)
Status: Draft
Version: 26.00.00
...
Outputs:
  - PlanningFile: "/Aliens/.Alien/{Developer_Username}/Planning/PyApp/{AppName}/Section/{SectionNameNormalized}.Update.md"
  - AuditFile: "/Aliens/.Alien/{Developer_Username}/Planning/PyApp/{AppName}/Section/{SectionNameNormalized}.Update.audit.md"
NonNegotiables:
...
- `MissingComponents[]` (must be created via PyApp_Component before applying section update)
...
- If component is required and missing: plan must explicitly say "Create via PyApp_Component workflow (dependency step)".
