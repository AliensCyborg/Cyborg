---
WorkflowId: PyApp_Screen_Update-Audit
WorkflowName: PyApp Screen Update (Audit)
Type: Workflow_Singular-Audit
Domain: PyApp
Scope: Audit existing PyApp Screen + CSS before update (read-only)
Status: Draft
Version: 26.00.00
...
Outputs:
  Audit:
    ...
    FileName: "Audit.md"
  Artifacts:
    SaveTo: "/Aliens/.Alien/{Developer_Username}/Planning/PyApp/{AppName}/Screen/"
...
- Deterministic artifact (hard):
  - `/Aliens/.Alien/{Developer}/Planning/PyApp/{AppName}/Screen/{ScreenNameNormalized}.Update.audit.md`
