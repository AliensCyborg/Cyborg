---
WorkflowId: WebApp-Research
WorkflowName: WebApp Research
Type: Workflow_Plural
Domain: WebApp
Scope: Enterprise-grade research for a new WebApp
Status: Draft
Version: 26.00.00
...
# [0] Purpose
`Workflow("WebApp-Research", "{AppName}", "{Description}")`
...
- `/Aliens/.Alien/{Developer}/Research/WebApp/{AppName}/Sources.md`
- `/Aliens/.Alien/{Developer}/Research/WebApp/{AppName}/OpenQuestions.md`
