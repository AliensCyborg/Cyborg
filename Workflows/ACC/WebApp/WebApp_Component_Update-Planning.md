---
WorkflowId: WebApp_Component_Update-Planning
Type: Workflow_Singular-Planning
Domain: WebApp
Scope: Generate update planning for a WebApp Component (per target)
Status: Draft
Version: 26.00.00
...
Outputs:
  - PlanningFile: "/Aliens/.Alien/{Developer_Username}/Planning/WebApp/{AppName}/Component/{ComponentNameNormalized}.Update.md"
  - AuditFile: "/Aliens/.Alien/{Developer_Username}/Planning/WebApp/{AppName}/Component/{ComponentNameNormalized}.Update.audit.md"
NonNegotiables:
...
- Any risky patterns (inline PHP islands vs heredoc)
