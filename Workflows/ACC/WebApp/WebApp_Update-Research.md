---
WorkflowId: WebApp_Update-Research
WorkflowName: WebApp Update Research
...
Outputs:
	Artifacts:
		SaveTo: "/Aliens/.Alien/{Developer_Username}/Research/WebApp/{AppName}/"
		FileName: "WebApp_Update-Research.md"
Safety:
	NoDelete: true
	ProdWrite: "no"
...
# [0] Purpose
`Workflow("WebApp_Update-Research", "{AppName}", "{Description}")`
...
- `/Aliens/.Alien/{Developer}/Research/WebApp/{AppName}/WebApp_Update-Sources.md`
- `/Aliens/.Alien/{Developer}/Research/WebApp/{AppName}/WebApp_Update-OpenQuestions.md`
