---
WorkflowId: WebApp_Component-Documentation
Type: Workflow_Singular-Documentation
Domain: WebApp
Scope: Generate documentation for a WebApp Component
Status: Draft
Version: 26.00.00
...
- ComponentFile: `{AppRoot}/User/component/{ComponentNameNormalized}.php`
...
- Action: run `WebApp_Component-Code` first.
