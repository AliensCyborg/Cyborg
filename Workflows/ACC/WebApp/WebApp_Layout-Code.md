---
WorkflowId: WebApp_Layout-Code
Type: Workflow_Singular-Code
Domain: WebApp
Scope: Generate a WebApp Layout part PHP file (+ optional Layout CSS file) (create-only)
Status: Draft
Version: 26.00.00
...
Outputs:
  - LayoutFile: "/Aliens/WebApp/{AppName}/26.00.00/theme/{AppName}_Basic/User/layout/{LayoutNameNormalized}.php"
  - CssFile: "/Aliens/WebApp/{AppName}/26.00.00/theme/{AppName}_Basic/User/css/{LayoutNameNormalized}-Layout.css" 
NonNegotiables:
...
1) Layout part PHP file create karta hai
...
- Action: run `WebApp_Layout-Planning`

---

# [5] Code Generation Rules
## 5.1 Layout Philosophy (Non-negotiable)
- Layout part is a lightweight fragment included by `User/layout.php`.
- No business logic.
- No destructive side-effects.
- Safe include: should not depend on global mutable state beyond standard WebOS globals.

## 5.2 Required PHP Patterns
