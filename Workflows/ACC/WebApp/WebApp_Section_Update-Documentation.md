---
WorkflowId: WebApp_Section_Update-Documentation
Type: Workflow_Singular-Documentation
Domain: WebApp
Scope: Update documentation for an existing WebApp Section
Status: Draft
Version: 26.00.00
...
- Action: run `WebApp_Section_Update-Code` (or create workflow if missing)
