---
WorkflowId: WebApp_Component_Update-Audit
WorkflowName: WebApp Component Update (Audit)
Type: Workflow_Singular-Audit
Domain: WebApp
Scope: Audit existing WebApp Component + CSS before update (read-only)
Status: Draft
Version: 26.00.00
...
- Deterministic artifact (hard):
  - `/Aliens/.Alien/{Developer}/Planning/WebApp/{AppName}/Component/{ComponentNameNormalized}.Update.audit.md`
...
3) Internal code-header exists for non-trivial PHP logic blocks (BackendGuard region) (Purpose/Input/Output)
...
- No PHP `function` declarations / closures / classes inside component files
