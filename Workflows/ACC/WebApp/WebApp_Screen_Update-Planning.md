---
WorkflowId: WebApp_Screen_Update-Planning
Type: Workflow_Singular-Planning
Domain: WebApp
Scope: Generate update planning for a WebApp Screen (per target)
Status: Draft
Version: 26.00.00
...
Outputs:
  - PlanningFile: "/Aliens/.Alien/{Developer_Username}/Planning/WebApp/{AppName}/Screen/{ScreenNameNormalized}.Update.md"
  - AuditFile: "/Aliens/.Alien/{Developer_Username}/Planning/WebApp/{AppName}/Screen/{ScreenNameNormalized}.Update.audit.md"
NonNegotiables:
...
- `MissingSections[]` (must be created via WebApp_Section before applying screen update)
...
- If section is required and missing: plan must explicitly say "Create via WebApp_Section workflow (dependency step)".
