---
WorkflowId: WebApp_Section_Update-Audit
WorkflowName: WebApp Section Update (Audit)
Type: Workflow_Singular-Audit
Domain: WebApp
Scope: Audit existing WebApp Section + CSS before update (read-only)
Status: Draft
Version: 26.00.00
...
- Deterministic artifact (hard):
  - `/Aliens/.Alien/{Developer}/Planning/WebApp/{AppName}/Section/{SectionNameNormalized}.Update.audit.md`
