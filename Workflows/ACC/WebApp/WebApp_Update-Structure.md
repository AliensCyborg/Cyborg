---
WorkflowId: WebApp_Update-Structure
WorkflowName: WebApp Update Structure
...
Outputs:
  ...
  Artifacts:
    ...
    FileName: "WebApp_Update-Structure.md"
Safety:
  NoDelete: true
  ProdWrite: "no"
...
# [0] Purpose
`Workflow("WebApp_Update-Structure", "{AppName}", "{Description}")`
...
- Action: run `WebApp_Structure` (create app) OR fix the app version/theme path
...
Rules:
- `Code_Path` MUST point to the primary PHP file for that task (when applicable).
...
## Screen update group
Worklflow in:
- `WebApp_Screen_Update`, `WebApp_Screen_Update-Code`
...
Worklflow in:
- `WebApp_Section_Update`, `WebApp_Section_Update-Code`
...
Worklflow in:
- `WebApp_Component_Update`, `WebApp_Component_Update-Code`
