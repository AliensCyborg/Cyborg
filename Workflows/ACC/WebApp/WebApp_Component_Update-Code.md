---
WorkflowId: WebApp_Component_Update-Code
Type: Workflow_Singular-Code
Domain: WebApp
Scope: Update a WebApp Component + its CSS file (modify-only)
Status: Draft
Version: 26.00.00
...
Outputs:
  - ComponentFile: "/Aliens/WebApp/{AppName}/26.00.00/theme/{AppName}_Basic/User/component/{ComponentNameNormalized}.php"
  - CssFile: "/Aliens/WebApp/{AppName}/26.00.00/theme/{AppName}_Basic/User/css/{ComponentNameNormalized}.css"
NonNegotiables:
...
- ComponentNameNormalized (canonical; SSOT): prefix rule per `Workflows/ACC/_Refs/WebApp_Naming_and_Screens.md`
...
- Prefer safe echo/heredoc output; avoid risky inline PHP islands in markup.
...
Component PHP me heavy processing (conditions/loops/array_merge/htmlspecialchars/component calls) **sirf** is guard ke andar:
