---
WorkflowId: WebApp_CSS_Update
Type: Workflow_Plural
Domain: WebApp
Scope: Update existing WebApp App-Level CSS (modify-only)
Status: Draft
Version: 26.00.00
...
Example:
- Workflow( "WebApp_CSS_Update", "Trip", "Adjust brand colors + add new layout utilities" )
