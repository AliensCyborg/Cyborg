---
WorkflowId: PySDK_Module_JS-Code
WorkflowName: PySDK Module JS Code Generator
...
Produces:
  - JsFile: "/Aliens/PySDK/{Python.Version}/Module/{Module}/js/index.js"
...
Rules:
- Do not delete `js/index.py` if it exists.
...
- This JS file is the module-level JS surface for the system (PyApps must NOT embed custom JS inside PyApp files).
