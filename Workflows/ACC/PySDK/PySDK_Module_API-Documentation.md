---
WorkflowId: PySDK_Module_API-Documentation
WorkflowName: PySDK Module API Documentation Generator
...
# PySDK_Module_API-Documentation.md
...
**Role (Hinglish):**  
Yeh file `PySDK_Module_API` workflow ke liye **documentation generator** hai.  
Iska kaam: planning + actual generated API file ko read karke **enterprise-grade docs** banana aur `/Aliens/Docs/PySDK/` me save karna.

> Important: Is file me sirf **PySDK Module APIs documentation** ke unique rules honge.  
...
Targets:
- `Module/ApiName` => PySDK module + API name
...
- `{PlanDoc} = /Aliens/.Alien/{Developer_Username}/Planning/PySDK/Module/{Module}/API/{ApiName}.plan.md`
...
## [09] Example
`Workflow("PySDK_Module_API", "User/UserNew", "Docs must be premium and enterprise readable")`
Docs should appear at:
- `/Aliens/Docs/PySDK/Module/User/API/UserNew.md`
