...
Summary: >
  Plural workflow that generates/updates the SQL schema bundle for one or multiple PySDK modules.
  This workflow orchestrates Planning -> Code -> Documentation per Module target.
Requires:
  - "Workflows/ACC/_Common/Workflow_Universal.md"
  - "Workflows/ACC/_Common/Workflow_Plural.md"
Calls:
  - "Workflows/ACC/PySDK/PySDK_Module_SQL-Planning.md"
  - "Workflows/ACC/PySDK/PySDK_Module_SQL-Code.md"
  - "Workflows/ACC/PySDK/PySDK_Module_SQL-Documentation.md"
Inputs:
  - Name: Targets
    Type: string
    Required: true
...
## Purpose
`PySDK_Module_SQL` ek **Plural** workflow hai jo PySDK module ke SQL artifacts generate/update karta hai.

Example:
- `Workflow("PySDK_Module_SQL", "Teacher", "Teacher module ka SQL schema bundle banado")`
- `Workflow("PySDK_Module_SQL", "Teacher,User,Account", "In modules ka SQL update karo")`
...
2) Resolve version (latest, fallback `Py.26.00.00`)
3) Resolve paths:
   - ModuleRoot: `/Aliens/PySDK/{Python.Version}/Module/{Module}/`
   - SqlFile: `/Aliens/PySDK/{Python.Version}/Module/{Module}/sql/index.sql`
4) Call child workflows in order:
   - `Workflow("PySDK_Module_SQL-Planning", "<Module>", "<Description>")`
   - `Workflow("PySDK_Module_SQL-Code", "<Module>", "<Description>")`
   - `Workflow("PySDK_Module_SQL-Documentation", "<Module>", "<Description>")`
...
- Missing module folder is an error by default.
  - If user wants to bootstrap a module, run `PySDK_Module` first.
...
- Docs created under `/Aliens/Docs/PySDK/Module/{Module}/SQL/`
