---
WorkflowId: PySDK_Module_SQL_Update-Planning
WorkflowName: PySDK Module SQL Update Planning
...
ExampleFiles:
  - "/Aliens/PySDK/Py.26.00.00/Module/Product/sql/index.sql"
---

# PySDK_Module_SQL_Update-Planning.md
...
- Action: run `PySDK_Module` first

If `{SqlFile}` missing:
- Mark `Failed(TargetMissing)`
- ErrorCode: `WF_SQL_FILE_MISSING`
- Action: if you want create, run `PySDK_Module_SQL` (NOT Update)
