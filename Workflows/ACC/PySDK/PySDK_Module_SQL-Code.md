---
WorkflowId: PySDK_Module_SQL-Code
WorkflowName: PySDK Module SQL Code Generator
Type: Workflow_Singular-Code
ParentWorkflowId: PySDK_Module_SQL
Domain: PySDK
Status: Draft
Version: 26.00.00
...
- `/Aliens/.Alien/{Developer_Username}/Planning/PySDK/Module/{Module}/SQL/index.plan.md`
