---
WorkflowId: PySDK_Module_SQL_Update-Audit
WorkflowName: PySDK Module SQL Update (Audit)
...
Outputs:
  Audit:
    ...
    FileName: "Audit.md"
  Artifacts:
    SaveTo: "/Aliens/.Alien/{Developer_Username}/Planning/PySDK/Module/{Module}/SQL/"
...
## [00] Purpose
Is workflow ka kaam: **enterprise-grade audit** of an existing PySDK module SQL file (`sql/index.sql`) before update.
...
- Also write a stable copy for downstream steps:
  - `/Aliens/.Alien/{Developer}/Planning/PySDK/Module/{Module}/SQL/index.update.audit.md`
